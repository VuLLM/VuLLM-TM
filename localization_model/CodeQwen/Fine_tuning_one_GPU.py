...
def main(path_trainset, path_testset, is_vulgen, output_dir, learning_rate, per_device_train_batch_size, num_train_epochs, generation_num_beams):
    ...
    train, test = Prepare_data_original.create_datasets_for_only_decoder(tokenizer, with_spaces=True, path_trainset=path_trainset, path_testset=path_testset, is_vulgen=is_vulgen)
