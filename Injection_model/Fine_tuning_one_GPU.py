...
import Prepare_dataset_with_unique_lines
import argparse
...
def main(path_trainset, path_testset, is_vulgen, output_dir, learning_rate, per_device_train_batch_size, num_train_epochs, generation_num_beams):    
    ...
    tokenized_train, tokenized_test = Prepare_dataset_with_unique_lines.create_datasets(tokenizer, path_trainset, path_testset, is_vulgen=is_vulgen)
    ...
    model.config.encoder.max_length = 496
    model.config.decoder.max_length = 496
